    ...
    return (
        <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
            <HomeCard
                ...
                handeClick={() => (setMeetingState('isInstantMeeting'))}
            ...
            <HomeCard
                ...
                handeClick={() => (setMeetingState('isScheduleMeeting'))}
                className="bg-blue-1"
            />
            <HomeCard
                ...
                handeClick={() => router.push('/recordings')}
            ...
            <HomeCard
                ...
                handeClick={() => (setMeetingState('isJoiningMeeting'))}
